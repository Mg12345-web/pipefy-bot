// ARQUIVO AJUSTADO: Robô exclusivamente para cadastro de clientes (CRLV removido)
...
async function executarRobo() {
  ...
  try {
    console.log('🔄 Iniciando robô de cadastro de cliente...');
...
app.get('/start', async (req, res) => {
  ...
  res.send('<h3>✅ Robô de clientes iniciado. Acompanhe os logs no Railway.</h3>');
  await executarRobo();
});
